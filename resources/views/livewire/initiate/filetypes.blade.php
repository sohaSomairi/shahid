<div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container p-3">
                        <form wire:submit.prevent='savefiletype'>
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                <div class="row">
                                    <label class="control-label col-sm-2" for="name">النوع</label>
                                    <div class="col-sm-10">
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click='savefiletype' type="submit" class="btn  comp-btn"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click='deletfiletype' type="button" class="btn btn-danger"
    ...
    <div class="col-12">
        <div class="comp-header">
            ...
            @can('forqanshahid.addFiletype', Auth::user()->id)
                ...
                <tbody>
                    @foreach ($filetypes as $filetype)
                        <tr>
                            <td>{{ $filetype->id }}</td>
                            <td>{{ $filetype->name }}</td>
                            <td>{{ $filetype->user->name }}</td>
                             @can('forqanshahid.editFiletype', Auth::user()->id)
                            <td>
                                <button data-bs-target="#edit" data-bs-toggle="modal"
                                    wire:click='setfiletype({{ $filetype->id }})' class="btn comp-btn">
                                    <li class="fa fa-edit"></li>
                                </button>
                            </td>
                            @endcan
                            @can('forqanshahid.deletFiletype', Auth::user()->id)
                            <td>
                                <button data-bs-target="#delete" data-bs-toggle="modal"
                                    wire:click='setfiletype({{ $filetype->id }})' class="btn btn-danger">
